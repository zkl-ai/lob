...
#             )
            num_patches = 100 #self.grid_size[0] * self.grid_size[1]
...
#                 nn.Linear(patch_dim, embedding_dim),
            ...
            self.linear_projection = nn.Linear(patch_dim, embedding_dim)
        elif conv_stem:
            assert (
    ...
    def _init_weights(self):
        if not self.conv_stem:
            trunc_normal_(self.pos_embed, std=0.01)
