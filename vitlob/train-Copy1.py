...
def batch_gd(model, criterion, optimizer, train_loader, test_loader, epochs):
    train_losses, test_losses = load_loss()
...
#         test_losses[it] = test_loss
        ...
        np.savetxt('train_losses_vit0.01_10_p2.txt', train_losses)
        np.savetxt('test_losses_vit0.01_k10_p2.txt', test_losses)
...
if __name__ == '__main__':
    ...
    model = torch.load('cur_iter_model_pytorch').to(device)#ViT().to(device)
